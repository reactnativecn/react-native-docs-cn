...
<div class="props">
	...
	<div class="prop">
		...
		<div>
			<p>给当前标签指定一个自定义的图标。如果定义了`systemIcon`属性， 这个属性会被忽略。</p>
		</div>
	</div>
	<div class="prop">
		...
		<div>
			<p>当此标签被选中时调用。你应该修改组件的状态来使得selected={true}.</p>
		</div>
	</div>
	<div class="prop">
	...
	<div class="prop">
		...
		<div>
			<p>当标签被选中的时候显示的自定义图标。如果定义了`systemIcon`属性，这个属性会被忽略。如果定义了`icon`而没定义这个属性，在选中的时候图标会染上蓝色。</p>
		</div>
	</div>
	<div class="prop">
	...
	<div class="prop">
		...
		<div>
			<p>在图标下面显示的标题文字。如果定义了`systemIcon`属性，这个属性会被忽略。</p>
		</div>
	</div>
</div>